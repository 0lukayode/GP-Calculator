...
public class Point7 extends Activity {
    ...
    public void addItemsOnSpinner() {
        ...
        String[] itemsgr = new String[]{"F(0-39)", "E(40-44)","E+(45-49)", "D(50-54)","D+(55-59)", "C(60-64)", "B(65-69)", "A(70-100)"};
    ...
    public void onClick(View view) {
        ...
        i.putExtra("theremark", theremark);
         startActivity(i);
    }
    ...
    public double setGpapoint() {
        ...
        if ((gpapoint >= 6.00) && (gpapoint < 7.00)) {
            gparemark = "First-Class";
        } else if ((gpapoint >= 4.60) && (gpapoint < 5.99)) {
            gparemark = "Second Class Upper";
        } else if ((gpapoint >= 2.60) && (gpapoint < 4.59)) {
            gparemark = "Second Class Lower";
        } else if ((gpapoint >= 1.60) && (gpapoint < 2.59)) {
            gparemark = "Third Class ";
        } else if ((gpapoint >= 0.00) && (gpapoint < 1.49)) {
            gparemark = "Fail";
        }
