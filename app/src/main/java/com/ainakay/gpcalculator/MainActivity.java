...
public class MainActivity extends Activity {
    ...
    public void addItemsOnSpinner() {
        ...
        String[] itemsgr = new String[]{"F(0-39)", "E(40-44)", "D(45-49)", "C(50-59)", "B(60-69)", "A(70-100)"};
    ...
    public double setGpapoint() {
        ...
        if ((gpapoint >= 4.50) && (gpapoint < 5.00)) {
            gparemark = "First-Class";
        } else if ((gpapoint >= 3.50) && (gpapoint < 4.49)) {
            gparemark = "Second Class Upper";
        } else if ((gpapoint >= 2.50) && (gpapoint < 3.49)) {
            gparemark = "Second Class Lower";
        } else if ((gpapoint >= 1.50) && (gpapoint < 2.49)) {
